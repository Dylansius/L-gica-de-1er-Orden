...
def ontologias():
    #Ontologias y RDF (Resource Description Framework)
    ...
    g.add((juan, FOAF.name, Literal("Juan Perez")))
    g.add((ana, FOAF.name, Literal("Ana Sanchez")))
    g.add((miguel, FOAF.name, Literal("Miguel Garcia")))
...
op=input("Que tipo de ingenieria del conocimiento deseas intentar: \n1.-Sistemas Expertos\n2.-Sistemas de Recomendacion\n3.-Ontologias y RDF (Resource Description Framework)\n")
if op == '1':
    si_expertos()
elif op == '2':
    si_recomendacion()
